...
```bash
$ node genTrxKey.js
5D4B3AAD5F94FD58D08C174162E04AC6C6A79FBF7D950D41B783361C54B9685F

$ node genTrxKey.js --info
{ privateKey:
   '5D4B3AAD5F94FD58D08C174162E04AC6C6A79FBF7D950D41B783361C54B9685F',
  publicKey:
   '04D668758BCCDFBE835A7212028F244BBB8299530233AAE5E57D2B8AD84E5B595E08BA5DCD5C95088493679DE320EBAA642DBB8B3A8224167B582F8686F223F6FA',
  address:
   { base58: 'TJSdyDahEAcscZVmPZ4xuVGtgRb22T6pgN',
     hex: '415CF11466635F2948B9DEDE85C6576A212CC67813' } }
```
...
```bash
$ node getTrxAddress.js
請輸入私鑰: 5D4B3AAD5F94FD58D08C174162E04AC6C6A79FBF7D950D41B783361C54B9685F
TJSdyDahEAcscZVmPZ4xuVGtgRb22T6pgN

$ node getTrxAddress.js --key 5D4B3AAD5F94FD58D08C174162E04AC6C6A79FBF7D950D41B783361C54B9685F
TJSdyDahEAcscZVmPZ4xuVGtgRb22T6pgN
```
...
```bash
$ node getTrxAddress.js --hex
請輸入私鑰: 5D4B3AAD5F94FD58D08C174162E04AC6C6A79FBF7D950D41B783361C54B9685F
415cf11466635f2948b9dede85c6576a212cc67813

$ node getTrxAddress.js --hex --key 5D4B3AAD5F94FD58D08C174162E04AC6C6A79FBF7D950D41B783361C54B9685F
415cf11466635f2948b9dede85c6576a212cc67813
```
